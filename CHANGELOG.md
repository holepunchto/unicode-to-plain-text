...
- `stripBoxChars(text)` - Strips Unicode characters that render as rectangle boxes in iOS notifications. Targets 50+ Unicode blocks confirmed unrenderable (historical scripts, obscure musical notation, legacy computing symbols) while preserving all major writing systems, emoji, CJK, math alphanumeric symbols, and modern symbol blocks.
